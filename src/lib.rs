...
//! `aamio-python`, `aamio-php` and `aamio-go` open, and the other way round.
//! The test vectors are shared.
//!
//! ```no_run
...
pub use gate::{
    ...
    solve, solve_board, zero_bits, Plan, ADVISE_MAX_BITS, REQUIRE_MAX_BITS,
};
pub use keys::{
